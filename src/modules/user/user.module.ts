...
// user 도메인 스키마(users, social_accounts) 리포지토리를 제공·export한다.
...
@Module({
    ...
    providers: [UserService, UserRepository, SocialAccountRepository],
    exports: [UserRepository, SocialAccountRepository],
})
