...
export const ApiListRecommendations = () =>
    applyDecorators(
        ApiOperation({
            ...
            description:
                '홈 화면의 자주 저장한 키워드 섹션에 사용할 폴더·태그 목록입니다. 활성 링크 수 내림차순으로 정렬하고, 동점이면 최근 조회 시각을 사용합니다. 전체 후보가 4개 이상일 때만 목록을 반환하며, 3개 이하면 클라이언트가 섹션 전체를 숨길 수 있도록 data를 null로 반환합니다.',
        }),
        ApiQuery({
            name: 'limit',
            required: false,
